...
// 1) 本機請用 http://localhost，不要 file:// 以免 origin = null
// 2) 只送一個簡單 header：Content-Type: text/plain


await fetch('https://script.google.com/macros/s/AKfycbx8CGXMrEKLaJ9-tSKm1a_Gb5Np757XWPNCh2ikmqVODIEsM7WKJRjIC4GWMkAzmc0k/exec', {
  method: 'POST',
  headers: { 'Content-Type': 'text/plain' }, // ★關鍵：simple request
  body: JSON.stringify(payload)               // 字串化就好
})
